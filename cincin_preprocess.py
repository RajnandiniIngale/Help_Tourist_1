...
print('')
file = open("cincin_food.txt", "w", encoding="utf-8")
file1 = open("cincin_money.txt", "w", encoding="utf-8")
file2 = open("cincin_location.txt", "w", encoding="utf-8")
file3 = open("cincin_service.txt", "w", encoding="utf-8")
...
file1 = open('cincinreviews.txt', 'r')
Lines = file1.readlines()
my_dict={}
count = 0
sumc=0;
...
print("stars",stars)
ffile.writelines("cincin_compound :" + ((str))(stars) + "\n")
keys = list(my_dict.keys())
values = list(my_dict.values())
