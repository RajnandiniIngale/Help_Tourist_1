...
print('')
file = open("parakh_food.txt", "w", encoding="utf-8")
file1 = open("parakh_money.txt", "w", encoding="utf-8")
file2 = open("parakh_location.txt", "w", encoding="utf-8")
file3 = open("parakh_service.txt", "w", encoding="utf-8")
...
file1 = open('parakh_reviews.txt', 'r')
Lines = file1.readlines()
my_dict={}
count = 0
sumc=0;
...
print("stars",stars)
ffile.writelines("parakh_compound :" + ((str))(stars) + "\n")
keys = list(my_dict.keys())
values = list(my_dict.values())
