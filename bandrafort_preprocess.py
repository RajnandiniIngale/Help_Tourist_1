...
data = pd.read_csv('bandrafort.csv')
...
print('')
pfile = open("bandrafort_all.txt", "w", encoding="utf-8")
...
# Using readlines()
file1 = open('bandrafort_all.txt', 'r',encoding="utf-8")
Lines = file1.readlines()
ffile = open("bandrafort.txt", "w", encoding="utf-8")
reviewfile = open("bandrafortreviews.txt","w",encoding="utf-8")
count = 0
sum=0
...
ffile.writelines("bandrafort_all :" +((str))(stars)+"\n")

print(sum)

file1.close()
reviewfile.close()
file1 = open('bandrafortreviews.txt', 'r' ,encoding='UTF-8')
...
print(sorted_dict)
with open('static/js/bandraforttest.csv', 'w',encoding='UTF-8') as f:
    for key in sorted_dict.keys():
        f.write("%s,%s\n"%(key,sorted_dict[key]))

file1.close()

file1 = open('bandrafortreviews.txt', 'r')
Lines = file1.readlines()
my_dict={}
count = 0
sumc=0;
...
print("stars",stars)
ffile.writelines("bandrafort_compound :" + ((str))(stars) + "\n")
