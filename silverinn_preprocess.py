...
file1.close()
reviewfile.close()
file1 = open('silverinnreviews.txt', 'r' ,encoding='UTF-8')
...
print(sorted_dict)
with open('static/js/silverinntest.csv', 'w',encoding='UTF-8') as f:
    for key in sorted_dict.keys():
        f.write("%s,%s\n"%(key,sorted_dict[key]))

file1.close()

file1 = open('silverinnreviews.txt', 'r')
Lines = file1.readlines()
my_dict={}
count = 0
sumc=0;
...
print("stars",stars)
ffile.writelines("silverinn_compound :" + ((str))(stars) + "\n")
